...
const std::vector<Preset>& getFactoryPresets()
{
    static const std::vector<Preset> presets =
    {
        { "Distant Nebula", {
            ...
            { pid::shimmer, 22 }, { pid::shimPitch, 12 }, { pid::shimFree, 0 },
            ...
            { pid::delaySync, 0 }, { pid::delayDiv, (float) tempo::kDefaultDivision },
        ...
        { "Cathedral of Ice", {
            ...
            { pid::shimmer, 44 }, { pid::shimPitch, 12 }, { pid::shimFree, 0 },
        ...
        { "Whisper of Light", {
            ...
            { pid::shimmer, 14 }, { pid::shimPitch, 19 }, { pid::shimFree, 0 },
        ...
        { "Solar Wind", {
            ...
            { pid::shimmer, 34 }, { pid::shimPitch, 7 }, { pid::shimFree, 0 },
        ...
        { "Supernova", {
            ...
            { pid::shimmer, 78 }, { pid::shimPitch, 12 }, { pid::shimFree, 0 },
        ...
        { "Event Horizon", {
            ...
            { pid::shimmer, 40 }, { pid::shimPitch, 12 }, { pid::shimFree, 0 },
        ...
        { "Gravity Well", {
            ...
            { pid::shimmer, 10 }, { pid::shimPitch, -12 }, { pid::shimFree, 0 },
        ...
        { "Black Hole Roar", {
            ...
            { pid::shimmer, 26 }, { pid::shimPitch, -12 }, { pid::shimFree, 0 },
        ...
        { "Heat Death", {
            ...
            { pid::shimmer, 30 }, { pid::shimPitch, 12 }, { pid::shimFree, 0 },
        ...
        { "Slow Light", {
            ...
            { pid::shimmer, 18 }, { pid::shimPitch, 12 }, { pid::shimFree, 0 },
        ...
        { "Photon Sphere", {
            ...
            { pid::shimmer, 20 }, { pid::shimPitch, 12 }, { pid::shimFree, 0 },
